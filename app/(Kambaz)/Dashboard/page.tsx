                ...
                {courses.map((c) => (
                    <div className="col wd-dashboard-course" key={c.id} style={{ width: "300px" }}>
                        <div className="card h-100 shadow-sm border-0 d-flex flex-column">
                            {/* Image links to the course */}
                            <Link href={`/Courses/${c.id}/Home`} className="text-decoration-none">
                            ...
                            <div className="card-body d-flex flex-column flex-grow-1 position-relative pb-5">
                                {/* Title links to the course */}
                                <Link href={`/Courses/${c.id}/Home`} className="wd-dashboard-course-link text-decoration-none text-dark">
                                ...
                                {/* Go button: a separate link, not nested inside another link */}
                                <Link
