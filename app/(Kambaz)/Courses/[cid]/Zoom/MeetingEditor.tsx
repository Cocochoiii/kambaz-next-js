...
// The dialog that schedules a new meeting. It is the same shape as
// ModuleEditor. The fields live in the Zoom screen, so I send them up
// and down. There is no time input in the book, so the hour is a dropdown.
