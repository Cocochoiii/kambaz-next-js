...
// This is a layout, not a page, because Path Parameters needs a nested screen
// inside Lab 3. That screen arrives as children and I pass it down.
// I need "use client" because the console.log has to reach the browser.
...
export default function Lab3Layout({ children }: Readonly<{ children: ReactNode }>) {
  ...
  return (
    <div id="wd-lab3" className="container">
      ...
      {/* 3.6.1 Child components. The content goes in the body of the tag. */}
      <h4>Square of 4</h4>
      <Square>4</Square>
      <hr />
      <Highlight>
