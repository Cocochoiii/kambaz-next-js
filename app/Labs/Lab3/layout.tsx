...
// Lab 3. The exercises of Chapter 3, in the order of the book.
// It is a layout because Path Parameters needs a nested screen.
...
export default function Lab3Layout({ children }: Readonly<{ children: ReactNode }>) {
  // The book asks me to write to the console.
  ...
  return (
    <div id="wd-lab3" className="container">
      ...
      {/* Child components. The content goes inside the tag. */}
      <h4>Square of 4</h4>
      <Square>4</Square>
      <hr />
      <Highlight>
      ...
      {/* The same todos as Lab 4, read from the store */}
      <TodosFromStore />
