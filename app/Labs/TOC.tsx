...
// The table of contents. It links to every lab, to Kambaz, and to my GitHub.
// The pill of the page I am on is active. Next.js gives me the current URL
// with usePathname, the same way the book uses useLocation.
